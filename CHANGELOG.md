...
* Fixed several linting problems. ([#294](https://github.com/Roblox/roact/pull/294))
* Made a few small performance changes (reducing indexing, checking optional values being nil before type checking them, using `string.x` instead of `:x`). ([#294](https://github.com/Roblox/roact/pull/294))
* Made the code better follow the [Roblox Lua Style Guide](https://roblox.github.io/lua-style-guide/). ([#294](https://github.com/Roblox/roact/pull/294))
