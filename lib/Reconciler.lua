...
function Reconciler._setRbxProp(rbx, key, value, element)
	if type(key) == "string" then
		...
		if key == "Name" then
			error("Name prop shouldn't be specified because Roact overwrites it. " .. element._source)
		end

		if key == "Parent" then
			error("Parent prop shouldn't be specified because Roact overwrites it. " .. element._source)
		end
